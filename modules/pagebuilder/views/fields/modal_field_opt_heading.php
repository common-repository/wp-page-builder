  ...
  <div class="sfdc-tab-pane sfdc-in sfdc-active" id="sfdc-fields-opt-col-1">
      ...
      <div class="zgpb-opt-divider-stl1"></div>
                             <div class="space15"></div>
                               <div class="sfdc-row">
                                        <div class="sfdc-col-md-12">
                                            <label ><?php echo __('HTML heading','zgpbd_admin'); ?> ( <i class="fa fa-header"></i> ) </label>
                                            <div class="sfdc-controls sfdc-form-group">
                                                <div class="sfdc-btn-group sfdc-btn-group-justified" data-toggle="buttons">
                                                    <label 
                                                        data-field-store="input1-h_type"
                                                        data-toggle-enable="sfdc-btn-success sfdc-active"
                                                        data-toggle-disable="sfdc-btn-success"
                                                        data-settings-option="group-radiobutton"
                                                        class="sfdc-btn sfdc-btn-success zgpb-f-setoption-btn" >
                                                    <input type="radio" 
                                                        id="zgpb_fld_text_inp_heading_1"
                                                        name="zgpb_fld_text_inp_heading_1" value="0">   <?php echo __('H1','zgpbd_admin'); ?>
                                                    </label>
                                                    <label 
                                                        data-field-store="input1-h_type"
                                                        data-toggle-enable="sfdc-btn-success sfdc-active"
                                                        ...
                                                        class="sfdc-btn sfdc-btn-success zgpb-f-setoption-btn" >
                                                    <input type="radio" 
                                                        id="zgpb_fld_text_inp_heading_2"
                                                        name="zgpb_fld_text_inp_heading_2" value="1">   <?php echo __('H2','zgpbd_admin'); ?>
                                                    </label>
                                                    <label 
                                                        data-field-store="input1-h_type"
                                                        data-toggle-enable="sfdc-btn-success sfdc-active"
                                                        ...
                                                        class="sfdc-btn sfdc-btn-success zgpb-f-setoption-btn" >
                                                    <input type="radio" 
                                                        id="zgpb_fld_text_inp_heading_3" 
                                                        name="zgpb_fld_text_inp_heading_3" value="2">  <?php echo __('H3','zgpbd_admin'); ?>
                                                    </label>
                                                    <label 
                                                        data-field-store="input1-h_type"
                                                        data-toggle-enable="sfdc-btn-success sfdc-active"
                                                        ...
                                                        class="sfdc-btn sfdc-btn-success zgpb-f-setoption-btn" >
                                                    <input type="radio" 
                                                        id="zgpb_fld_text_inp_heading_4" 
                                                        name="zgpb_fld_text_inp_heading_4" value="3">  <?php echo __('H4','zgpbd_admin'); ?>
                                                    </label>
                                                    <label 
                                                        data-field-store="input1-h_type"
                                                        data-toggle-enable="sfdc-btn-success sfdc-active"
                                                        ...
                                                        class="sfdc-btn sfdc-btn-success zgpb-f-setoption-btn" >
                                                    <input type="radio" 
                                                        id="zgpb_fld_text_inp_heading_5" 
                                                        name="zgpb_fld_text_inp_heading_5" value="4">   <?php echo __('H5','zgpbd_admin'); ?>
                                                    </label>
                                                    <label 
                                                        data-field-store="input1-h_type"
                                                        data-toggle-enable="sfdc-btn-success sfdc-active"
                                                        ...
                                                        class="sfdc-btn sfdc-btn-success zgpb-f-setoption-btn" >
                                                    <input type="radio" 
                                                        id="zgpb_fld_text_inp_heading_6" 
                                                        name="zgpb_fld_text_inp_heading_6" value="5">  <?php echo __('H6','zgpbd_admin'); ?>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
