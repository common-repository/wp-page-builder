...
<div class="sfdc-tab-content">
  <div class="sfdc-tab-pane sfdc-in sfdc-active" id="sfdc-fields-opt-col-1">
      <div class="sfdc-tab-content2">
          <fieldset>
                    <legend><?php echo __('html editor','zgpbd_admin'); ?> </legend>
                        ...
                        <div class="sfdc-row ">
                            <div class="sfdc-col-md-12">
                                <div class="sfdc-form-group">
                                    ...
                                    <div class="sfdc-col-md-12">
                                        <div class="zgpb-field-fhtml-htmlsrc-wrap">
                                            <textarea id="zgpb-field-fhtml-htmlsrc" name="zgpb-field-fhtml-htmlsrc">
