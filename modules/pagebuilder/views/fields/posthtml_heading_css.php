...
ob_start();
?>
 #zgpbf_<?php echo $id;?> .zgpb-input1-text h1,
 #zgpbf_<?php echo $id;?> .zgpb-input1-text h2,
 #zgpbf_<?php echo $id;?> .zgpb-input1-text h3,
 #zgpbf_<?php echo $id;?> .zgpb-input1-text h4,
 #zgpbf_<?php echo $id;?> .zgpb-input1-text h5,
 #zgpbf_<?php echo $id;?> .zgpb-input1-text h6
 {
    <?php
    //label
    ?>
