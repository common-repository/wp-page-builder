...
if (class_exists('Zgpbld_Base_Module')) {
    return;
}
 ...
 */
abstract class Zgpbld_Base_Module {
    ...
    protected static function render_template($default_template_path = false, $variables = array(), $require = 'once') {
        ...
        $template_path = apply_filters('zgpbld_rocket_template_path', $template_path);
        ...
        if (is_file($template_path)) {
            ...
            $template_content = apply_filters('zgpbld_rocket_template_content', ob_get_clean(), $default_template_path, $template_path, $variables);
        } else {
            $template_content = '';
        }
