 (function(a) {
    ...
    var c = {
            ...
            input: "input",
            container: !1,
            component: ".add-on, .sfdc-input-group-addon",
            sliders: {
                saturation: {
                    maxLeft: 100,
                    maxTop: 100,
            ...
            template: '<div class="colorpicker sfdc-dropdown-menu"><div class="colorpicker-saturation"><i><b></b></i></div><div class="colorpicker-hue"><i></i></div><div class="colorpicker-alpha"><i></i></div><div class="colorpicker-color"><div /></div></div>'
        },
        d = function(d, e) {
            this.element = a(d).addClass("colorpicker-element"), 
                    this.boxcont=a('#zgpb-modal1 .sfdc-modal-content'),
            ...
            .addClass("sfdc-wrap")
            .append(this.picker)),*/
                    //this.picker.appendTo(a("#zgpb-modal1")),
    ...
    d.version = "2.0.0-beta", d.Color = b, d.prototype = {
        ...
        reposition: function() {
            ...
            /*this.picker.css({
                top: b.top - 30+ (this.component ? this.component.outerHeight() : this.element.outerHeight()),
                left: b.left
            })*/
            
            this.picker.css({
                top: b.top + this.component.offset().top - this.boxcont.offset().top +30,
                left: this.component.offset().left - this.boxcont.offset().left
            })
        },
        show: function(b) {
            ...
            this.reposition(), 
            a(window).on("resize.colorpicker",
                    a.proxy(this.reposition, this)
                    ), !this.hasInput() && b && b.stopPropagation && b.preventDefault && (b.stopPropagation(), b.preventDefault()),
